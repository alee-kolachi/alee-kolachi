...
USER_NAME = os.environ.get('USER_NAME', 'alee-kolachi')
...
if __name__ == '__main__':
    """
    Profile-card generator for alee-kolachi.
    Mechanism adapted from Andrew Grant's (Andrew6rant) public neofetch-readme project.
    """
    print('Calculation times:')
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(1998, 12, 25))
